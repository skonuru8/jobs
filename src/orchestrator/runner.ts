 ...
 *   2. Spawn `npx tsx scripts/run-pipeline.ts` with correct env
...
// We treat the process CWD as the repo root (npm start runs from repo root).
// Tests can override this via PROJECT_ROOT.
