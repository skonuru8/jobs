...
describe("runner — spawnRun", () => {
  ...
  it("returns 0 when child exits cleanly", async () => {
    ...
    const { spawnRun } = await import("@/orchestrator/runner.js");
    ...
    const { acquireLock } = await import("@/orchestrator/lock.js");
  ...
  it("releaseLock is called regardless of child exit code", async () => {
    const { releaseLock } = await import("@/orchestrator/lock.js");
  ...
  it("monitor checkRun is called after child exits", async () => {
    const { checkRun } = await import("@/orchestrator/monitor.js");
    const { acquireLock } = await import("@/orchestrator/lock.js");
